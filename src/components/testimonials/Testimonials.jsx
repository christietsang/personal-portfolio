...
import SZ from "../../assets/Sepehr.jpg"
import BK from "../../assets/belal.jpg"
                        ...
                        <OwlCarousel className="owl-carousel" id="testimonial-carousel"{...carousel_options}>
                                ...
                                <div className="testimonial-item">
                                    ...
                                    <div className="client-info">
                                        <div className="picture-container">
                                            <img src={BK} alt="placeholder" className="profile-picture" />
                                        </div>
                            ...
                            <div className="col-lg-12">
                                <div className="testimonial-item">
                                    ...
                                    <div className="client-info">
                                        <div className="picture-container">
                                            <img src={HP} alt="placeholder" className="profile-picture" />
                                        </div>
                                        <div className="subtitles">
                                            <h5>Hailey P.</h5>
                            ...
                            <div className="col-lg-12">
                                <div className="testimonial-item">
                                    ...
                                    <div className="client-info">
                                        <div className="picture-container">
                                            <img src={KM} alt="placeholder" className="profile-picture" />
                                        </div>
                                        <div className="subtitles">
                                            <h5>Kiley M.</h5>
                                            <p>Acting Team Leader</p>
                            ...
                            <div className="col-lg-12">
                                <div className="testimonial-item">
                                    <div className="testimonial-comment">
                                        <FormatQuoteRoundedIcon className="quote-icon" />
                                        <p>
                                            Christie is the ideal person I want to work with in a group project. She is hardworking, resilient and full of positive energy. One of her strengths is that she never shies away from a challenge.
                                        </p>
                                    </div>
                                    <div className="client-info">
                                        <div className="picture-container">
                                            <img src={SZ} alt="placeholder" className="profile-picture" />
                                        </div>
                                        <div className="subtitles">
                                            <h5>Sepehr Z.</h5>
                                            <p>Group project-mate</p>
